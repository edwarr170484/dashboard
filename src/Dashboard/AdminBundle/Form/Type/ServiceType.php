...
class ServiceType extends AbstractType
{
    ...
    {    
        $builder
            ...
            ->add('icon', TextareaType::class, array('required' => false,'label' => 'Иконка', 'attr' => array('class' => 'form-control', 'placeholder' => 'Иконка')))
            ...
            ->add('days', TextType::class, array('required' => true,'label' => 'Количество единиц измерения на которое подключается услуга', 'attr' => array('class' => 'form-control', 'placeholder' => 'Количество дней на которое подключается услуга')))
