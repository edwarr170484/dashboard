...
class RegionFilterType extends AbstractType
{
    ...
    {
        $builder->add('regionFilter', 'entity', array('class' => 'DashboardCommonBundle:Region', 
        ...
        $formModifier = function (FormInterface $form, Region $region = null) {
                ...
                $form->add('cityFilter', 'entity', array('class' => 'DashboardCommonBundle:City',
            ...
            $builder->get('regionFilter')->addEventListener(
