...
class UserAddAdvertType extends AbstractType
{
    ...
    {    
        $builder
            ...
            ->add('authorPhone', TextType::class, array('required' => false, 'data' => $this->user->getPhone() ,'label' => 'Jūsu tālrunis', 'attr' => array('class' => 'form-control')))
            ->add('region', 'entity', array('class' => 'DashboardCommonBundle:Region', 
                    ...
                    'attr' => array('class' => 'custom-select','id' => 'region', 'placeholder' => 'Atrašanās vieta')))
            ...
            ->add('term', ChoiceType::class, array('choices' => array("7" => "Nedēļa", "14" => "2 nedēļas", "30" => "Mēnesis", "90" => "3 mēneši"),'required' => true, 'attr' => array('class' => 'custom-select')))
            ...
            ->add('viewcommon', CheckboxType::class, array('required' => false, 'label' => 'обычная продажа', 'attr' => array('class' => 'hidden-input', 'id' => 'data-checkbox=viewcommon data-radio=view', 'text' => $this->translator->trans('<span>Regulāra tirdzniecība</span>'))))
            ...
            ->add('termsAccept', CheckboxType::class, array(
                ...
                'text' => $this->translator->trans('<div class="agreement-text">*Es piekrītu pakalpojuma <a href="" data-toggle="modal" data-target="#userAgreementModal"> lietošanas noteikumiem </a>, kā arī manu datu pārsūtīšanai un apstrādei uz gribupardot.sunweb.by. Es apstiprinu savu vairākumu un atbildību par reklāmas izvietošanu.</div>'))))
            ->add('save', ButtonType::class, array('label' => 'Publicēt', 'attr' => array('class' => 'form-main-button')));
