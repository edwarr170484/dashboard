...
AutoFill.prototype = {
	...
	"_fnInit": function ( dt, config )
	{
		...
		/* Events */
		filler.on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/mousedown.DTAF', function (e) {
		...
		$('tbody', this.dom.table).on(
			'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/mouseover.DTAF mouseout.DTAF',
			'>tr>td, >tr>th',
			function (e) {
		...
		$(this.dom.table).on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/destroy.dt.DTAF', function () {
			filler.off( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/mousedown.DTAF' ).remove();
			$('tbody', this.dom.table).off( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/mouseover.DTAF mouseout.DTAF' );
		} );
	},
