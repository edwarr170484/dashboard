...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	...
	"_fnConstruct": function ( oInit )
	{
		...
		$(this.dom.scroller)
			.on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/mouseover.DTFC touchstart.DTFC', function () {
				mouseController = 'main';
			} )
			.on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/scroll.DTFC', function () {
		...
		var wheelType = 'onwheel' in document.createElement('div') ?
			'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/wheel.DTFC' :
			'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/mousewheel.DTFC';
		...
		$(window).on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/resize.DTFC', function () {
		...
		jqTable
			.on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/draw.dt.DTFC', function () {
				that._fnDraw.call( that, bFirstDraw );
				bFirstDraw = false;
			} )
			.on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/column-sizing.dt.DTFC', function () {
				that._fnColCalc();
				that._fnGridLayout( that );
			} )
			.on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/column-visibility.dt.DTFC', function () {
				that._fnColCalc();
				that._fnGridLayout( that );
				that._fnDraw( true );
			} )
			.on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/destroy.dt.DTFC', function () {
				jqTable.off( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/column-sizing.dt.DTFC destroy.dt.DTFC draw.dt.DTFC' );

				$(that.dom.scroller).off( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/scroll.DTFC mouseover.DTFC' );
				$(window).off( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/resize.DTFC' );
	...
	"_fnDraw": function ( bAll )
	{
		...
		/* Event triggering */
		$(this).trigger( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/draw.dtfc', {
