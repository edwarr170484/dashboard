...
FixedHeader.prototype = {
	...
	fnInit: function ( oDtSettings, oInit )
	{
		...
		$(s.nTable)
			.on('http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/column-reorder.dt', function () {
				FixedHeader.fnMeasure();
				that._fnUpdateClones( true );
				that._fnUpdatePositions();
			} )
			.on('http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/column-visibility.dt', function () {
				FixedHeader.fnMeasure();
				that._fnUpdateClones( true );
				that._fnUpdatePositions();
			} );
