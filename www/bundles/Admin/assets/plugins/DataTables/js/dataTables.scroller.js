 ...
 *        $('#example').dataTable( {
 *            "sScrollY": "200px",
 *            "sAjaxSource": "http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/media/dataset/large.txt",
 *            "sDom": "frtiS",
 *            "bDeferRender": true
 *        } );
 *    } );
...
Scroller.prototype = /** @lends Scroller.prototype */{
	...
	"_fnConstruct": function ()
	{
		...
		$(this.dom.scroller).on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/scroll.DTS', function (e) {
		 ...
		 */
		$(this.dom.scroller).on('http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/touchstart.DTS', function () {
			that._fnScroll.call( that );
		} );
		...
		$(window).on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/resize.DTS', function () {
		...
		this.s.dt.aoDestroyCallback.push( {
			"sName": "Scroller",
			"fn": function () {
				$(window).off( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/resize.DTS' );
				$(that.dom.scroller).off('http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/touchstart.DTS scroll.DTS');
