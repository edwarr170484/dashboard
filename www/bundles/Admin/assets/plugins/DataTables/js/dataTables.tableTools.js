...
TableTools.prototype = {
	  ...
	  var nButton = this._fnButtonBase( oConfig, bCollectionButton );
		...
		if ( this.s.dt.iTabIndex !== -1 ) {
			$(nButton)
				...
				.on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/keyup.DTTT', function (e) {
				...
				.on( 'http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/mousedown.DTTT', function (e) {
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		 ...
		 */
		$(document).bind( "http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/keydown.DTTT", function(e) {
	...
	"_fnPrintEnd": function ( e )
	{
		...
		$(document).unbind( "http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/DataTables/js/keydown.DTTT" );
	},
...
TableTools.BUTTONS = {
	...
	"ajax": $.extend( {}, TableTools.buttonBase, {
		"sAjaxUrl": "http://seantheme.com/xhr.php",
