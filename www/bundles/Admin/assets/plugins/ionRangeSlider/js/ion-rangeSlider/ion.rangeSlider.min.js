...
b+"px"},Z=function(){var b={input:e,slider:p,min:a.min,max:a.max,fromNumber:0,toNumber:0,fromPers:0,toPers:0,fromX:0,fromX_pure:0,toX:0,toX_pure:0},d=a.max-a.min,h;"single"http://seantheme.com/color-admin-v1.6/admin/html/assets/plugins/ionRangeSlider/js/ion-rangeSlider/===a.type?(b.fromX=c.data(w[0],"x")||parseInt(w[0].style.left,10)||w.position().left,b.fromPers=b.fromX/E*100,h=d/100*b.fromPers+a.min,b.fromNumber=Math.round(h/a.step)*a.step,b.fromNumber<a.min&&(b.fromNumber=a.min),b.fromNumber>a.max&&(b.fromNumber=a.max),u&&(b.fromNumber=parseInt(b.fromNumber*u,10)/u),H&&(b.fromValue=a.values[b.fromNumber])):
